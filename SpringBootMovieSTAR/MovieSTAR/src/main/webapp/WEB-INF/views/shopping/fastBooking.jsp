...
<body>
        ...
        <div class="breadcrumbs">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li><a href="<c:url value="/movieList.controller" />">電影時刻</a></li>
                    <li>線上訂票</li>
                </ul>
                <ul class="go-home">
                    <li><a href="<c:url value="/movieList.controller" />">返回</a></li>
                </ul>
            </div>
        </div>
        <!-- END BREADCRUMB -->
    ...
    <script>
        ...
        function movieItem() {
            ...
            xhr.open('GET', '<c:url value="/fastSchedule.controller"/>', true);
            xhr.send();
        ...
        function ticket() {
            ...
            selectTime = new Date(schedule.date+'T'+schedule.time);
            var xhr = new XMLHttpRequest();
            ...
            var bPicture = '<div class="hadding-area">' +
                ...
                '<ul><li><a style="cursor: pointer;font-size: 20px" onclick=sub() >繼續 <i class="fa fa-arrow-right" aria-hidden="true"></i></a></li></ul></div>';
