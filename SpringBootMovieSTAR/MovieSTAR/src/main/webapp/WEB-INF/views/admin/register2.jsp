		...
		email.onclick = function(){
  		...
  		email.onblur = function() {
  			...
  			if(!emailValue){
  				...
  				ih5.innerHTML =  "<font color='red' >*(ex:your@gmail.com)</font>";
  				flag5=false;
  			}else{
  				ih5.innerHTML =  "";
  				flag5 = true;
                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                            ...
                            <div class="user">
                                ...
                                <input style="outline-color:green;" type="text" name="userid" id="userid" placeholder="User*" class="form-control form-control-user">
                                <span  id="ih1"></span><br>
                                </div>
                                <div class="form-group">
                                <input style="outline-color:green;" type="password" name="password" id="password" placeholder="Password*" class="form-control form-control-user">
                                <span style="color: red;" id="ih2"></span><br>
                                 <br><button><i class="fa fa-eye" aria-hidden="true" id="btnn"></i></button><br>
      							</div>
                                
                                <div class="form-group">
                                <input style="outline-color:green;" type="password" name="password1" id="password1" placeholder="Confirm Password*" class="form-control form-control-user">
                                <span style="color: red;" id="ih3"></span><br>
                                </div>
                                <div class="form-group">
                                <input style="outline-color:green;" type="text" name="name" id="name" placeholder="Your Name*" class="form-control form-control-user">
                                <span style="color: red;" id="ih4"></span><br>
                                </div>
                                <div class="form-group">
                                <input style="outline-color:green;" type="text" name="email" id="email" placeholder="Email*" class="form-control form-control-user">
                                <span style="color: red;" id="ih5"></span><br>
                                </div>
                                <div class="form-group">
                                <input style="outline-color:green;" type="text" name="birthday" id="birthday" placeholder="Your Birthday*" class="form-control form-control-user">
                               ...
                               <!--  <div class="loggedin-forgot d-inline-flex my-3">
                                ...
                                <div align="center">
                                <button type="submit" id="sendData" class="btn btn-primary  py-2 px-2 bg-primary text-gray border-0 rounded font-weight-bold" >Register Now</button>
                                <button id="quick" class="btn btn-primary  py-2 px-2 bg-primary text-gray border-0 rounded font-weight-bold" >快速輸入</button>
                                </div>
                            </div>
                            <hr>
                            <div class="text-center">
                                <a class="small" href="<c:url value='/forgetpwd.controller' />">Forgot Password?</a>
                            </div>
                            <div class="text-center">
                                <a class="small" href="<c:url value='/login.controller' />">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
