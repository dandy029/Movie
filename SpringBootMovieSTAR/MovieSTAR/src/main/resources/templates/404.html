                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 top-account sm-width sm-width-33">
                            <div class="top-accounts">
                                <ul>
                                    ...
                                    <li><a href=""><span class="fa fa-lock"></span>Login</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 top-message sm-width sm-width-33">
                            <div class="top-messages">
                                <p><span class="fa fa-envelope-o"></span> Superhit Top Movie <strong class="green">** King Star **</strong></p>
                            </div>
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-menu">
                        <ul class="nav navbar-nav navbar-left" data-in="" data-out="">
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Celebritie</a>
                                <ul class="dropdown-menu">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">404 page</a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">LogIn page</a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Comming soon</a>
                                        <ul class="dropdown-menu">
                        ...
                        <div class="row">
                            <div class="col-lg-offset-4 col-md-offset-4 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="error-content text-center">
                                    <h2><span>404</span></h2>
                                    <ul>
                                        <li><span>Someting’s Missing.</span></li>
                                    </ul>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since.</p>
                                    <div class="buttons">
                                        <a href="" class="btn btn-button green-bg button-1">Go Back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="ft-content twitter-contnt">
                                    ...
                                    <div class="ft-twitter-feed">
                                        ...
                                        <div class="twitter-dec">
                                            <a href="">blck-one <span class="green">@24Webpro</span></a>
